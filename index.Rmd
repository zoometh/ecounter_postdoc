...
The candidate will have to manage \textsf{R} programming, GitHub and Zenodo repositories
...
Monte-Carlo simulation used in MCMC used for radiocarbone SPD are also use in the K-Ripley point pattern test
